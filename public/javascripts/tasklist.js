//THIS IS BASICALLY THE BRIDGE BETWEEN THE FRONTEND AND THE BACKEND USING AXIOS AND THE POST METHOD

const TaskList = (function(){

    const registerUser = (user) => {

          // here id use axios to send it to the backend then the backend would then put it to my database
